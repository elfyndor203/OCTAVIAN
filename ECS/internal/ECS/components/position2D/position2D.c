...
componentIndex position2DAddNew(gameObjectIndex parentIndex) {								// attaches a new default position2D to some gameObject
	if (gameObjectHasComponent(parentIndex, componentPosition2D)) {
